...
**Theorem (Nash, 1954/1956; analytic 1966).** Every $n$-dimensional Riemannian manifold $(M,g)$ is isometrically embeddable in $\mathbb{R}^N$ for $N$ sufficiently large. The $C^1$ (isometric but highly non-smooth) embeddings were proved by Nash in $1954$ (Ann. of Math. $60$, 383–396) and by Kuiper in $1955$. Nash's $1956$ paper (*The imbedding problem for Riemannian manifolds*, Ann. of Math. $63$, 20–63) solves the $C^k$ and $C^\infty$ cases for $N = n(3n+11)/2$, and it is in that paper that he introduces the smoothing-operator / modified-Newton method that overcomes the derivative loss — the method Moser later abstracted into the general Nash–Moser implicit function theorem (§10). The real-analytic case followed in $1966$ (Ann. of Math. $84$, 345–355). (Improved, and in some regimes optimal, bounds are known; Günther's $1989$ proof gives a simpler local argument.)
...
**The heat kernel proof, and the local-to-global bridge.** The proof that makes the straightening principle explicit is the heat kernel proof (Atiyah–Patodi–Singer, *Ann. of Math.* **94** (1971), 113–138). The index can be written as
$$
...
- N. Kuiper, "On $C^1$-isometric imbeddings," *Proc. K. Ned. Akad. Wetensch.* **A58** (1955), 545–556.
...
- J. Moser, "A new technique for the construction of solutions of nonlinear differential equations," *Proc. Nat. Acad. Sci. U.S.A.* **47** (1962), 1824–1831.
- J. Moser, "A rapidly convergent iteration method and non-linear differential equations," *Ann. Scuola Norm. Sup. Pisa* **20** (1966), 499–535.
...
- M. F. Atiyah, V. K. Patodi, and I. M. Singer, "Heat and the Zeta-function," *Ann. of Math.* **94** (1971), 113–138.
